  ...
  return (
    <div className="min-h-screen bg-[#0b0f14] text-white px-6 py-5">
      ...
      <div    className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-10 align-items: center">
        ...
        <div  onClick={() => navigate("/call")} className="rounded-2xl bg-[#121821] border border-cyan-500 h-44 flex flex-col items-center justify-center hover:border-cyan-500/30 transition">
        ...
        <div className="rounded-2xl bg-[#121821] border border-cyan-500 h-44 flex flex-col items-center justify-center hover:border-cyan-500/30 transition">
